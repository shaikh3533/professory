...
class GetData {
    ...
    Grades(mthd) {
        axios.get('subjects/grades?lang=eng')
            .then((res) => {
                // console.log(res)
                if (res.data.success) {
    ...
    async ProfessorsComments(professorID){
        const response=await axios.get(`professors/comments/get?id=${professorID}`)
    ...
    Universities(countryID, mthd) {
        axios.get(`univeristeries/get?id=${countryID}`)
            .then((res) => {
                // console.log(res)
                if (res.data.success) {
    ...
    Colleges(univID, mthd) {
        axios.get(`colleges/get?id=${univID}`)
            .then((res) => {
                // console.log(res)
                if (res.data.success) {
    ...
    Majors(collegeID, mthd){
        axios.get(`majors/get?id=${collegeID}`)
            .then((res) => {
    ...
    Subjects(majorID, mthd){
        axios.get(`subjects/get?id=${majorID}`)
            .then((res) => {
                // console.log(res)
                if (res.data.success) {
    ...
    TeachingStyle( mthd){
        axios.get("professors/teaching/style")
            .then((res) => {
    ...
    BookDetails = (data) => {
        const res = async () => {
            const resp = await axios.get('/user/BookStore/bookStore?bookType=Used Books')
            // .then((response) => {
            //     if (response) {
    ...
    CollegeProfessors = (data) => {
        const res = async () => {
            const resp = await axios.get(`/professors/getProfessorByCollege?id=${data}`)
            .catch(function (error) {
                console.log(error);
            });
