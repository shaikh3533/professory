                ...
                <div className="bordr p-1">
                    ...
                    <div className="row m-0 mt-1">
                        <div className="col-4 pl-1 pr-1">
                            <h5 className="text-left mb-1 Black">{props.Price}</h5>
                        </div>
                        <div className="col-8 pr-1 pl-1">
                            <p className="text-right my-1 FS_12 LightGray">{props.Date}</p>
                        </div>
                        <div className="col-10 pl-1 pr-1">
                            <p className="text-left Bold mb-1 Black">{props.Name}</p>
                        </div>
                        <div className="col-2 pr-1 pl-1">
                            <img className="d-block ml-auto" src={props.icon} alt="" />
                        </div>
                        <div className="col-12 px-1">
                            <p className="LightGray">{props.Description}</p>
                        </div>
                    </div>
                </div></NavLink>
        </div>
